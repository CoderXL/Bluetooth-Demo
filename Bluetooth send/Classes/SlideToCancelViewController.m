...
- (void)loadView {
	...
	UIImage *trackImage = [UIImage imageNamed:@"tab.png"];
	...
	UIImage *thumbImage = [UIImage imageNamed:@"rmb.png"];
	...
	NSString *labelText = NSLocalizedString(@"Move the slider to send", @"SlideToSend label");
